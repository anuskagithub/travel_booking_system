...
lbl_heading=Label(root, text="Kolkata to New Delhi",fg="black",bg="violet",font=("Times New Roman",25),relief="ridge",pady=10,border=10).pack(fill='x')
...
lstPack= []
lstPack.append("D:\Anuska\Travel2021\Daily_Travel_Booking\Pictures\KolkataToNewDelhi.PNG")
