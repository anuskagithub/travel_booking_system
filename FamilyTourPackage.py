...
def btnAsSearch_clik():
    ...
    if d==3:
        root.destroy()
        import Days3_All_Family_Packages
    if d==7:
        root.destroy()
        import Days7_All_Family_Packages
    
    if d==15:
        root.destroy()
        import Days15_All_Family_Packages
...
root.title("Family Package")
root.config(bg="white")

lbl_heading=Label(root, text="Family Tour Package",fg="black",bg="light green",font=("Times New Roman",25),relief="ridge",pady=10,border=10).pack(fill='x')
...
label_DurationOfVisit=Label(root, text="Duration of Visit:",fg="Black", font=("Times New Roman", 18, "bold"))
