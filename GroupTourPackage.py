...
def btnAsSearch_clik():
    ...
    if d==3:
        root.destroy()
        import Days3_All_Group_Packages
    if d==7:
        root.destroy()
        import Days7_All_Group_Packages
    
    if d==15:
        root.destroy()
        import Days15_All_Group_Packages
...
lbl_heading=Label(root, text="Group Tour Package",fg="black",bg="light green",font=("Times New Roman",25),relief="ridge",pady=10,border=10).pack(fill='x')
